...
export const MOCK_ADVICE_ARTICLES: AdviceArticle[] = [
  {
    ...
    category: "deals",
    title_en: "How Group Buying Works on Sharena",
  ...
  },
  {
    ...
    content_en:
      "Buy vouchers during group offers when discounts are deepest, then spend them gradually at your favourite brands.\n\nTrack remaining balances in your Sharena wallet and enable notifications so you never miss an expiry or balance update.",
    content_ar:
