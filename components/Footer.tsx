...
import type { SocialLinksData } from "../services";
...
export default function Footer({ socialData }: FooterProps) {
  ...
  return (
    <footer className="bg-[#340040] text-white py-12 px-4 md:px-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-start">
              {Array.isArray(socialData?.social) &&
                socialData.social.map((social: SocialLinksData["social"][number]) => (
                  <a
                    key={social._id}
                    href={social.link}
                    target="_blank"
